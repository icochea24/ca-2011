...
/**
 * Base class that represents a row from the 'pollaca2011_sch.grupo' table.
 *
 * 
 *
...
abstract class BaseGrupo extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the valorinscripcion field.
	 * @var        string
	 */
	protected $valorinscripcion;

	/**
	 * The value for the totalacumulado field.
	 * @var        string
	 */
	protected $totalacumulado;

	/**
	 * The value for the keygrupo field.
	 * @var        string
	 */
	protected $keygrupo;
	...
	/**
	 * Get the [valorinscripcion] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [totalacumulado] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [keygrupo] column value.
	 * 
	 * @return     string
	 */
	public function getKeygrupo()
	{
		return $this->keygrupo;
	}
	...
	public function setIdgrupo($v)
	{
		...
		if ($this->idgrupo !== $v) {
			$this->idgrupo = $v;
			$this->modifiedColumns[] = GrupoPeer::IDGRUPO;
		}
	...
	/**
	 * Set the value of [valorinscripcion] column.
	 * 
	 * @param      string $v new value
	 * @return     Grupo The current object (for fluent API support)
	 */
	public function setValorinscripcion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->valorinscripcion !== $v) {
			$this->valorinscripcion = $v;
			$this->modifiedColumns[] = GrupoPeer::VALORINSCRIPCION;
		}
	...
	/**
	 * Set the value of [totalacumulado] column.
	 * 
	 * @param      string $v new value
	 * @return     Grupo The current object (for fluent API support)
	 */
	public function setTotalacumulado($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->totalacumulado !== $v) {
			$this->totalacumulado = $v;
			$this->modifiedColumns[] = GrupoPeer::TOTALACUMULADO;
		}
	...
	/**
	 * Set the value of [keygrupo] column.
	 * 
	 * @param      string $v new value
	 * @return     Grupo The current object (for fluent API support)
	 */
	public function setKeygrupo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->keygrupo !== $v) {
			$this->keygrupo = $v;
			$this->modifiedColumns[] = GrupoPeer::KEYGRUPO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idgrupo = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->valorinscripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->totalacumulado = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->keygrupo = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 6; // 6 = GrupoPeer::NUM_HYDRATE_COLUMNS.
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(GrupoPeer::IDGRUPO) ) {
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getValorinscripcion();
				break;
			case 3:
				return $this->getTotalacumulado();
				break;
			case 4:
				return $this->getKeygrupo();
				break;
			case 5:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getValorinscripcion(),
			$keys[3] => $this->getTotalacumulado(),
			$keys[4] => $this->getKeygrupo(),
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->collUsuarioGrupos) {
				$result['UsuarioGrupos'] = $this->collUsuarioGrupos->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
		}
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setValorinscripcion($value);
				break;
			case 3:
				$this->setTotalacumulado($value);
				break;
			case 4:
				$this->setKeygrupo($value);
				break;
			case 5:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setValorinscripcion($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setTotalacumulado($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setKeygrupo($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GrupoPeer::IDGRUPO)) $criteria->add(GrupoPeer::IDGRUPO, $this->idgrupo);
		if ($this->isColumnModified(GrupoPeer::NOMBRE)) $criteria->add(GrupoPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(GrupoPeer::VALORINSCRIPCION)) $criteria->add(GrupoPeer::VALORINSCRIPCION, $this->valorinscripcion);
		if ($this->isColumnModified(GrupoPeer::TOTALACUMULADO)) $criteria->add(GrupoPeer::TOTALACUMULADO, $this->totalacumulado);
		if ($this->isColumnModified(GrupoPeer::KEYGRUPO)) $criteria->add(GrupoPeer::KEYGRUPO, $this->keygrupo);
	...
	{
		$criteria = new Criteria(GrupoPeer::DATABASE_NAME);
		$criteria->add(GrupoPeer::IDGRUPO, $this->idgrupo);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setValorinscripcion($this->getValorinscripcion());
		$copyObj->setTotalacumulado($this->getTotalacumulado());
		$copyObj->setKeygrupo($this->getKeygrupo());
	 ...
	 * If this Grupo is new, it will return
	 ...
	 * @return     PropelCollection|array Pronostico[] List of Pronostico objects
	 */
	public function getPronosticosJoinPartido($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PronosticoQuery::create(null, $criteria);
		$query->joinWith('Partido', $join_behavior);
	...
	public function initUsuarioGrupos($overrideExisting = true)
	{
		...
		$this->collUsuarioGrupos = new PropelObjectCollection();
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array UsuarioGrupo[] List of UsuarioGrupo objects
	 * @throws     PropelException
	 */
	public function getUsuarioGrupos($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collUsuarioGrupos || null !== $criteria) {
			if ($this->isNew() && null === $this->collUsuarioGrupos) {
				// return empty collection
				$this->initUsuarioGrupos();
			} else {
				$collUsuarioGrupos = UsuarioGrupoQuery::create(null, $criteria)
					->filterByGrupo($this)
					->find($con);
				if (null !== $criteria) {
	...
	public function countUsuarioGrupos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collUsuarioGrupos || null !== $criteria) {
			if ($this->isNew() && null === $this->collUsuarioGrupos) {
				...
				$query = UsuarioGrupoQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	public function addUsuarioGrupo(UsuarioGrupo $l)
	{
		...
		if (!$this->collUsuarioGrupos->contains($l)) { // only add it if the **same** object is not already associated
			$this->collUsuarioGrupos[]= $l;
			$l->setGrupo($this);
		}
	}
	...
	public function clearAllReferences($deep = false)
	{
		...
		$this->collPronosticos = null;
		if ($this->collUsuarioGrupos instanceof PropelCollection) {
			$this->collUsuarioGrupos->clearIterator();
		}
		$this->collUsuarioGrupos = null;
	}
