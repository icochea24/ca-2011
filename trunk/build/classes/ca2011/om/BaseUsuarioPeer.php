...
/**
 * Base static class for performing query and update operations on the 'pollaca2011_sch.usuario' table.
 *
 * 
 *
...
abstract class BaseUsuarioPeer {
	...
	const TABLE_NAME = 'pollaca2011_sch.usuario';

	/** the related Propel class for this table */
	const OM_CLASS = 'Usuario';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'ca2011.Usuario';
	...
	const IDUSUARIO = 'pollaca2011_sch.usuario.IDUSUARIO';

	/** the column name for the NOMBRE field */
	const NOMBRE = 'pollaca2011_sch.usuario.NOMBRE';

	/** the column name for the EMAIL field */
	const EMAIL = 'pollaca2011_sch.usuario.EMAIL';

	/** the column name for the CLAVE field */
	const CLAVE = 'pollaca2011_sch.usuario.CLAVE';

	/** the column name for the PAGOOK field */
	const PAGOOK = 'pollaca2011_sch.usuario.PAGOOK';

	/** the column name for the CLAVECONFIRMA field */
	const CLAVECONFIRMA = 'pollaca2011_sch.usuario.CLAVECONFIRMA';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idusuario', 'Nombre', 'Email', 'Clave', 'Pagook', 'Claveconfirma', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario', 'nombre', 'email', 'clave', 'pagook', 'claveconfirma', ),
		BasePeer::TYPE_COLNAME => array (self::IDUSUARIO, self::NOMBRE, self::EMAIL, self::CLAVE, self::PAGOOK, self::CLAVECONFIRMA, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDUSUARIO', 'NOMBRE', 'EMAIL', 'CLAVE', 'PAGOOK', 'CLAVECONFIRMA', ),
		BasePeer::TYPE_FIELDNAME => array ('idusuario', 'nombre', 'email', 'clave', 'pagook', 'claveconfirma', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idusuario' => 0, 'Nombre' => 1, 'Email' => 2, 'Clave' => 3, 'Pagook' => 4, 'Claveconfirma' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario' => 0, 'nombre' => 1, 'email' => 2, 'clave' => 3, 'pagook' => 4, 'claveconfirma' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::IDUSUARIO => 0, self::NOMBRE => 1, self::EMAIL => 2, self::CLAVE => 3, self::PAGOOK => 4, self::CLAVECONFIRMA => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDUSUARIO' => 0, 'NOMBRE' => 1, 'EMAIL' => 2, 'CLAVE' => 3, 'PAGOOK' => 4, 'CLAVECONFIRMA' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('idusuario' => 0, 'nombre' => 1, 'email' => 2, 'clave' => 3, 'pagook' => 4, 'claveconfirma' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UsuarioPeer::PAGOOK);
			$criteria->addSelectColumn(UsuarioPeer::CLAVECONFIRMA);
		} else {
			$criteria->addSelectColumn($alias . '.IDUSUARIO');
			$criteria->addSelectColumn($alias . '.NOMBRE');
			$criteria->addSelectColumn($alias . '.EMAIL');
			$criteria->addSelectColumn($alias . '.CLAVE');
			$criteria->addSelectColumn($alias . '.PAGOOK');
			$criteria->addSelectColumn($alias . '.CLAVECONFIRMA');
		}
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to pollaca2011_sch.usuario
	...
	/**
	 * Method to DELETE all rows from the pollaca2011_sch.usuario table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
