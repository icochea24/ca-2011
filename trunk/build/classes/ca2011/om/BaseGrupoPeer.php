...
/**
 * Base static class for performing query and update operations on the 'pollaca2011_sch.grupo' table.
 *
 * 
 *
...
abstract class BaseGrupoPeer {
	...
	const TABLE_NAME = 'pollaca2011_sch.grupo';

	/** the related Propel class for this table */
	const OM_CLASS = 'Grupo';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'ca2011.Grupo';
	...
	const IDGRUPO = 'pollaca2011_sch.grupo.IDGRUPO';

	/** the column name for the NOMBRE field */
	const NOMBRE = 'pollaca2011_sch.grupo.NOMBRE';

	/** the column name for the VALORINSCRIPCION field */
	const VALORINSCRIPCION = 'pollaca2011_sch.grupo.VALORINSCRIPCION';

	/** the column name for the TOTALACUMULADO field */
	const TOTALACUMULADO = 'pollaca2011_sch.grupo.TOTALACUMULADO';

	/** the column name for the KEYGRUPO field */
	const KEYGRUPO = 'pollaca2011_sch.grupo.KEYGRUPO';

	/** the column name for the ESTADO field */
	const ESTADO = 'pollaca2011_sch.grupo.ESTADO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idgrupo', 'Nombre', 'Valorinscripcion', 'Totalacumulado', 'Keygrupo', 'Estado', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idgrupo', 'nombre', 'valorinscripcion', 'totalacumulado', 'keygrupo', 'estado', ),
		BasePeer::TYPE_COLNAME => array (self::IDGRUPO, self::NOMBRE, self::VALORINSCRIPCION, self::TOTALACUMULADO, self::KEYGRUPO, self::ESTADO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDGRUPO', 'NOMBRE', 'VALORINSCRIPCION', 'TOTALACUMULADO', 'KEYGRUPO', 'ESTADO', ),
		BasePeer::TYPE_FIELDNAME => array ('idgrupo', 'nombre', 'valorinscripcion', 'totalacumulado', 'keygrupo', 'estado', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idgrupo' => 0, 'Nombre' => 1, 'Valorinscripcion' => 2, 'Totalacumulado' => 3, 'Keygrupo' => 4, 'Estado' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idgrupo' => 0, 'nombre' => 1, 'valorinscripcion' => 2, 'totalacumulado' => 3, 'keygrupo' => 4, 'estado' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::IDGRUPO => 0, self::NOMBRE => 1, self::VALORINSCRIPCION => 2, self::TOTALACUMULADO => 3, self::KEYGRUPO => 4, self::ESTADO => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDGRUPO' => 0, 'NOMBRE' => 1, 'VALORINSCRIPCION' => 2, 'TOTALACUMULADO' => 3, 'KEYGRUPO' => 4, 'ESTADO' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('idgrupo' => 0, 'nombre' => 1, 'valorinscripcion' => 2, 'totalacumulado' => 3, 'keygrupo' => 4, 'estado' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GrupoPeer::VALORINSCRIPCION);
			$criteria->addSelectColumn(GrupoPeer::TOTALACUMULADO);
			$criteria->addSelectColumn(GrupoPeer::KEYGRUPO);
			$criteria->addSelectColumn(GrupoPeer::ESTADO);
		} else {
			$criteria->addSelectColumn($alias . '.IDGRUPO');
			$criteria->addSelectColumn($alias . '.NOMBRE');
			$criteria->addSelectColumn($alias . '.VALORINSCRIPCION');
			$criteria->addSelectColumn($alias . '.TOTALACUMULADO');
			$criteria->addSelectColumn($alias . '.KEYGRUPO');
	...
	/**
	 * Method to invalidate the instance pool of all tables related to pollaca2011_sch.grupo
	...
	{
		return $withPrefix ? GrupoPeer::CLASS_DEFAULT : GrupoPeer::OM_CLASS;
	}
	...
	/**
	 * Method to DELETE all rows from the pollaca2011_sch.grupo table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
