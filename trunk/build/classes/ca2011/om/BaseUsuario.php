...
/**
 * Base class that represents a row from the 'pollaca2011_sch.usuario' table.
 *
 * 
 *
...
abstract class BaseUsuario extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the pagook field.
	 * @var        string
	 */
	protected $pagook;

	/**
	 * The value for the claveconfirma field.
	 * @var        string
	 */
	protected $claveconfirma;
	...
	/**
	 * Get the [pagook] column value.
	 * 
	 * @return     string
	 */
	public function getPagook()
	{
		return $this->pagook;
	}

	/**
	 * Get the [claveconfirma] column value.
	 * 
	 * @return     string
	 */
	public function getClaveconfirma()
	{
		return $this->claveconfirma;
	}
	...
	/**
	 * Set the value of [pagook] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	public function setPagook($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->pagook !== $v) {
			$this->pagook = $v;
			$this->modifiedColumns[] = UsuarioPeer::PAGOOK;
		}
	...
	/**
	 * Set the value of [claveconfirma] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	public function setClaveconfirma($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->claveconfirma !== $v) {
			$this->claveconfirma = $v;
			$this->modifiedColumns[] = UsuarioPeer::CLAVECONFIRMA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idusuario = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			...
			$this->pagook = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->claveconfirma = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(UsuarioPeer::IDUSUARIO) ) {
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getPagook();
				break;
			case 5:
				return $this->getClaveconfirma();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getPagook(),
			$keys[5] => $this->getClaveconfirma(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setPagook($value);
				break;
			case 5:
				$this->setClaveconfirma($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPagook($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setClaveconfirma($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsuarioPeer::PAGOOK)) $criteria->add(UsuarioPeer::PAGOOK, $this->pagook);
		if ($this->isColumnModified(UsuarioPeer::CLAVECONFIRMA)) $criteria->add(UsuarioPeer::CLAVECONFIRMA, $this->claveconfirma);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setPagook($this->getPagook());
		$copyObj->setClaveconfirma($this->getClaveconfirma());
