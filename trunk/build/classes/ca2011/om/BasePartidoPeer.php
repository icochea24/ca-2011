...
/**
 * Base static class for performing query and update operations on the 'pollaca2011_sch.partido' table.
 *
 * 
 *
 * @package    propel.generator.ca2011.om
 */
abstract class BasePartidoPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'ca2011';

	/** the table name for this class */
	const TABLE_NAME = 'pollaca2011_sch.partido';

	/** the related Propel class for this table */
	const OM_CLASS = 'Partido';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'ca2011.Partido';

	/** the related TableMap class for this table */
	const TM_CLASS = 'PartidoTableMap';
	...
	/** the column name for the RESULTADOEQUIPO2 field */
	const RESULTADOEQUIPO2 = 'pollaca2011_sch.partido.RESULTADOEQUIPO2';

	/** the column name for the FECHAHORA field */
	const FECHAHORA = 'pollaca2011_sch.partido.FECHAHORA';

	/** the column name for the SEDE field */
	const SEDE = 'pollaca2011_sch.partido.SEDE';

	/** the column name for the JUGADO field */
	const JUGADO = 'pollaca2011_sch.partido.JUGADO';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';
	
	/**
	 * An identiy map to hold any loaded instances of Partido objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. PartidoPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(PartidoPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PartidoPeer::SEDE);
			...
			$criteria->addSelectColumn($alias . '.SEDE');
			$criteria->addSelectColumn($alias . '.JUGADO');
		}
	}
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = PartidoPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return PartidoPeer::populateObjects(PartidoPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      mixed $value A Partido object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Partido) {
				$key = (string) $value->getIdpartido();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Partido object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Partido Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to pollaca2011_sch.partido
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = PartidoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = PartidoPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				PartidoPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (Partido object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = PartidoPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = PartidoPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + PartidoPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = PartidoPeer::OM_CLASS;
			$obj = new $cls();
	...
	{
	  $dbMap = Propel::getDatabaseMap(BasePartidoPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BasePartidoPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new PartidoTableMap());
	  }
	}
	...
	{
		return $withPrefix ? PartidoPeer::CLASS_DEFAULT : PartidoPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Partido or Criteria object.
	 *
	 * @param      mixed $values Criteria or Partido object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Partido object
		}

		if ($criteria->containsKey(PartidoPeer::IDPARTIDO) && $criteria->keyContainsValue(PartidoPeer::IDPARTIDO) ) {
	...
	/**
	 * Method perform an UPDATE on the database, given a Partido or Criteria object.
	 *
	 * @param      mixed $values Criteria or Partido object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PartidoPeer::IDPARTIDO);
			$value = $criteria->remove(PartidoPeer::IDPARTIDO);
			if ($value) {
				$selectCriteria->add(PartidoPeer::IDPARTIDO, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(PartidoPeer::TABLE_NAME);
			}

		} else { // $values is Partido object
	...
	/**
	 * Method to DELETE all rows from the pollaca2011_sch.partido table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(PartidoPeer::TABLE_NAME, $con, PartidoPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			PartidoPeer::clearInstancePool();
			PartidoPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Partido or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Partido object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Partido) { // it's a model object
			// invalidate the cache for this single object
			PartidoPeer::removeInstanceFromPool($values);
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(PartidoPeer::IDPARTIDO, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				PartidoPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given Partido object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Partido $obj The object to validate.
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(PartidoPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(PartidoPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(PartidoPeer::DATABASE_NAME, PartidoPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = PartidoPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(PartidoPeer::IDPARTIDO, $pk);

		$v = PartidoPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PartidoPeer::DATABASE_NAME);
			$criteria->add(PartidoPeer::IDPARTIDO, $pks, Criteria::IN);
			$objs = PartidoPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
