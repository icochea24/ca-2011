  ...
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="5"><table width="100%"  border="0">
          ...
          <tr>
            <td width="39%"><div align="right"><strong><span class="style2">Correo Electr&oacute;nico</span></strong></div></td>
            <td width="61%"><input name="correo" type="text" id="correo" size="40"></td>
          </tr>
          <tr>
