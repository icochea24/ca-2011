...
/**
 * Base class that represents a row from the 'pollaca2011_sch.usuario_grupo' table.
 *
 * 
 *
...
abstract class BaseUsuarioGrupo extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the idusuariogrupo field.
	 * @var        string
	 */
	protected $idusuariogrupo;
	...
	/**
	 * The value for the acumulado field.
	 * @var        int
	 */
	protected $acumulado;
	...
	/**
	 * Get the [idusuariogrupo] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [acumulado] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [idusuariogrupo] column.
	 * 
	 * @param      string $v new value
	 * @return     UsuarioGrupo The current object (for fluent API support)
	 */
	public function setIdusuariogrupo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->idusuariogrupo !== $v) {
			$this->idusuariogrupo = $v;
			$this->modifiedColumns[] = UsuarioGrupoPeer::IDUSUARIOGRUPO;
		}
	...
	public function setIdgrupo($v)
	{
		...
		if ($this->idgrupo !== $v) {
			$this->idgrupo = $v;
			$this->modifiedColumns[] = UsuarioGrupoPeer::IDGRUPO;
		}
	...
	public function setIdusuario($v)
	{
		...
		if ($this->idusuario !== $v) {
			$this->idusuario = $v;
			$this->modifiedColumns[] = UsuarioGrupoPeer::IDUSUARIO;
		}
	...
	/**
	 * Set the value of [acumulado] column.
	 * 
	 * @param      int $v new value
	 * @return     UsuarioGrupo The current object (for fluent API support)
	 */
	public function setAcumulado($v)
	{
		...
		if ($this->acumulado !== $v) {
			$this->acumulado = $v;
			$this->modifiedColumns[] = UsuarioGrupoPeer::ACUMULADO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idusuariogrupo = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(UsuarioGrupoPeer::IDUSUARIOGRUPO) ) {
						throw new PropelException('Cannot insert a value for auto-increment primary key ('.UsuarioGrupoPeer::IDUSUARIOGRUPO.')');
					}

					$pk = BasePeer::doInsert($criteria, $con);
					$affectedRows += 1;
					$this->setIdusuariogrupo($pk);  //[IMV] update autoincrement primary key
					$this->setNew(false);
				} else {
	...
	{
		if (isset($alreadyDumpedObjects['UsuarioGrupo'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['UsuarioGrupo'][$this->getPrimaryKey()] = true;
		$keys = UsuarioGrupoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdusuariogrupo(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdusuariogrupo($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsuarioGrupoPeer::IDUSUARIOGRUPO)) $criteria->add(UsuarioGrupoPeer::IDUSUARIOGRUPO, $this->idusuariogrupo);
	...
	{
		$criteria = new Criteria(UsuarioGrupoPeer::DATABASE_NAME);
		$criteria->add(UsuarioGrupoPeer::IDUSUARIOGRUPO, $this->idusuariogrupo);
	...
	/**
	 * Generic method to set the primary key (idusuariogrupo column).
	 *
	...
	{
		return null === $this->getIdusuariogrupo();
	}
	...
	{
		return (string) $this->exportTo(UsuarioGrupoPeer::DEFAULT_STRING_FORMAT);
	}
